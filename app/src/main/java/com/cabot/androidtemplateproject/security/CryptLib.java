...
public class CryptLib {
    ...
    private static String encryptDecrypt(String _inputText, String _encryptionKey,
                                         EncryptMode _mode, String _initVector) throws Exception /*UnsupportedEncodingException,
    ...
    public static String encrypt(String _plainText, String _key, String _iv)
            throws Exception /*InvalidKeyException, UnsupportedEncodingException,
     ...
     * @throws BadPaddingException
     */
    public static String decrypt(String _encryptedText, String _key, String _iv)
            throws Exception /*InvalidKeyException, UnsupportedEncodingException,
			InvalidAlgorithmParameterException, IllegalBlockSizeException,
			BadPaddingException */{
